...
version = pkg_resources.require('wagtail_factories')[0].version
release = version
...
#
# html_title = 'wagtail-factories v0.1.0'
...
htmlhelp_basename = 'wagtail-factoriesdoc'
...
latex_documents = [
    (master_doc, 'wagtail-factories.tex', 'wagtail-factories Documentation',
...
man_pages = [
    (master_doc, 'wagtail-factories', 'wagtail-factories Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'wagtail-factories', 'wagtail-factories Documentation',
     author, 'wagtail-factories', 'One line description of project.',
     'Miscellaneous'),
]
